...
class _DenseLayer(ivy.Module):
    ...
    def _forward(self, input):  # noqa: F811
...
class _Transition(ivy.Sequential):
    def __init__(self, num_input_features: int, num_output_features: int) -> None:
        ...
        self.pool = ivy.AvgPool2D(kernel_size=2, stride=2, data_format="NCHW")
        super().__init__()
...
class DenseNet(ivy.Module):
    ...
    def __init__(
        ...
        # Final batch norm
        self.features.add_module("norm5", ivy.BatchNorm2D(num_features))
    ...
    def _forward(self, x):
        ...
        out = ivy.relu(features, inplace=True)
