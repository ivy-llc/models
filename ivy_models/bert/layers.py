...
class Embedding(ivy.Module):
    def __init__(self,
        ...
        self.W_initializer = initializer if initializer is not None else ivy.stateful.initializers.GlorotUniform()
    ...
    def _forward(self, indices):
        emb = ivy.embedding(self.v.weight,
                            indices,
...
class BertEmbedding(ivy.Module):
    ...
    def _build(self, *args, **kwargs):
        self.word_embeddings = Embedding(self.vocab_size, self.hidden_size, padding_idx=self.padding_idx)
    ...
    def _forward(self,
        ...
        if position_ids is None:
            ...
            position_ids = pos_ids[:, past_key_values_length: seq_length + past_key_values_length]
...
class BertSelfAttention(ivy.Module):
    def __init__(self,
        ...
        self.position_type_embd = position_embedding_type if position_embedding_type is not None else 'abs'
...
class BertAttention(ivy.Module):
    ...
    def _build(self, *args, **kwargs):
        self.self = BertSelfAttention(self.hidden_size,
    ...
    def _forward(
            ...
            past_key_value=None,
            output_attentions=False, ):
        outputs = self.self(hidden_states,
                            attention_mask,
