...
#         return ivy.functional.gelu(input, approximate="tanh")
...
#     def forward(self, input: Array) -> Array:
#         return 0.5 * input * (1.0 + ivy.tanh(math.sqrt(2.0 / math.pi) * (input + 0.044715 * ivy.pow(input, 3.0))))
...
#     ivy.tanh(math.sqrt(2 / math.pi) * (x + 0.044715 * ivy.pow(x, 3)))) This is now written in C in ivy.functional
...
#         else:
#             self.act = ivy.functional.gelu

#     def _gelu_python(self, input: Array) -> Array:
#         return input * 0.5 * (1.0 + ivy.erf(input / math.sqrt(2.0)))
...
#     ivy.tanh(math.sqrt(2 / math.pi) * (x + 0.044715 * ivy.pow(x, 3)))). See https://arxiv.org/abs/1606.08415
#     """
...
#     def forward(self, input: Array) -> Array:
#         return ivy.functional.silu(input)


# class MishActivation(ivy.Module):
#     """
...
#     def __init__(self):
#         super().__init__()
#         if version.parse(ivy.__version__) < version.parse("1.9.0"):
#             self.act = self._mish_python
#         else:
#             self.act = ivy.functional.mish

#     def _mish_python(self, input: Array) -> Array:
#         return input * ivy.tanh(ivy.functional.softplus(input))
...
#         relu_applied = ivy.functional.relu(input)
