...
class Block(ivy.Module):
    ...
    def _build(self, *args, **kwargs):
        self.dwconv = ivy.DepthwiseConv2D(self.dim, [7,7], (1,1), 3, data_format="NCHW")
...
class ConvNeXt(ivy.Module):
    def __init__(self, in_channels=3, num_classes=1000,
                ...
                head_init_scale=1., device=None, training=False,
                v=None):
    ...
    def _build(self, *args, **kwargs):
        ...
        stem = ivy.Sequential(
            ivy.Conv2D(self.in_channels, self.dims[0], [4,4], (4,4), 0, data_format="NCHW"),
        ...
        for i in range(3):
            downsample_layer = ivy.Sequential(
                ...
                ivy.Conv2D(self.dims[i], self.dims[i+1], [2,2], (2,2), 0, data_format="NCHW")
            )
...
class LayerNorm(ivy.Module):
    ...
    """ 
    def __init__(self, num_channels, data_format, 
                eps=1e-6, device=None, v=None, dtype=None):
