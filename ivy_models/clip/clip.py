...
from .misc import get_model_args, get_ivy_weights
...
__all__ = ["available_models", "load_clip", "get_processors", "tokenize"]
...
def get_processors(model):
    """
    Returns the text tokenizer and the image processor.
    """
