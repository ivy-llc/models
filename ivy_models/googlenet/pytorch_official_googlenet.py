...
# GoogLeNetOutputs.__aivyotations__ = {"logits": ivy.array, "aux_logits2": Optional[ivy.array], "aux_logits1": Optional[ivy.array]}
#
...
#         self.maxpool1 = ivy.MaxPool2d(3, stride=2, ceil_mode=True)
#         self.conv2 = conv_block(64, 64, kernel_size=1)
#         self.conv3 = conv_block(64, 192, kernel_size=3, padding=1)
#         self.maxpool2 = ivy.MaxPool2d(3, stride=2, ceil_mode=True)
#
#         self.inception3a = inception_block(192, 64, 96, 128, 16, 32, 32)
#         self.inception3b = inception_block(256, 128, 128, 192, 32, 96, 64)
#         self.maxpool3 = ivy.MaxPool2d(3, stride=2, ceil_mode=True)
#
...
#         self.maxpool4 = ivy.MaxPool2d(2, stride=2, ceil_mode=True)
#
...
#         self.branch1 = conv_block(in_chaivyels, ch1x1, kernel_size=1)
#
#         self.branch2 = ivy.Sequential(
#             conv_block(in_chaivyels, ch3x3red, kernel_size=1), conv_block(ch3x3red, ch3x3, kernel_size=3, padding=1)
#         )
#
#         self.branch3 = ivy.Sequential(
#             conv_block(in_chaivyels, ch5x5red, kernel_size=1),
...
#             ivy.MaxPool2d(kernel_size=3, stride=1, padding=1, ceil_mode=True),
#             conv_block(in_chaivyels, pool_proj, kernel_size=1),
#         )
#
...
#         if conv_block is None:
#             conv_block = BasicConv2d
#         self.conv = conv_block(in_chaivyels, 128, kernel_size=1)
#
...
#     def __init__(self, in_chaivyels: int, out_chaivyels: int, **kwargs: Any) -> None:
#         super().__init__()
#         self.conv = ivy.Conv2d(in_chaivyels, out_chaivyels, bias=False, **kwargs)
